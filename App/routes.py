...
def edit_product(product_id):
    ...
    # Haal bestaande gegevens van het product op
    product_details = {
    ...
    # Initialiseer het formulier met productgegevens
    form = ProductForm(data=product_details)

    if request.method == "POST":
        try:
            # Update het product met de nieuwe gegevens
...
def supplier_create():
    if request.method == "POST":
        ...
        print(f"Received data: {name}, {phone_number}, {street_name}, {house_number}, {postal_code}, {website}")
